...
@WebServlet(name = "ActivityParticipantsServlet", value = "/activity-participants")
public class ActivityParticipantsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("activities/activity-participants.jsp").forward(request, response);
